...
```bash
curl -X POST 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass-location' \
...
```bash
curl -X PUT 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass-location/{locationId}' \
  -H 'api-key: <your-api-key>' \
  -H 'Content-Type: application/json' \
  -d '{
    "enabled": false
...
```bash
curl -X GET 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass-location?passSerialNumbers={passId}' \
  -H 'api-key: <your-api-key>'
```
...
```bash
curl -X DELETE 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass-location/{locationId}' \
  -H 'api-key: <your-api-key>'
```
