...
```bash
curl -X GET 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass/notifications/{notificationId}' \
...
```bash
curl -X GET 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass/notifications?passSerialNumber={passId}' \
  -H 'api-key: <your-api-key>'
```
...
```bash
curl -X GET 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass/notifications' \
  -H 'api-key: <your-api-key>'
```
...
```bash
curl -X GET 'https://wallet-pass-api-staging.nftco.com/v1/wallet-pass/notifications?status=scheduled' \
  -H 'api-key: <your-api-key>'
```
